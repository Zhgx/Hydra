...
class VplxDrbd(object):
    ...
    def __init__(self, logger):
        ...
        self.logger.write_to_log('T', 'INFO', 'info', 'start',
                                 '', f'start to config drbd resource {self.res_name}')
    ...
    def _drbd_up(self):
        ...
        '''
        self.logger.write_to_log(
            'T', 'INFO', 'info', 'start', '', f'info:start to drbd up for {self.res_name}')
        up_cmd = f'drbdadm up {self.res_name}'
        drbd_up = SSH.execute_command(up_cmd)
        if drbd_up['sts']:
            print(f'{self.res_name} up success')
            self.logger.write_to_log(
                'T', 'INFO', 'info', 'finish', '', f'{self.res_name} up success')
    ...
    def _drbd_primary(self):
        ...
        '''
        self.logger.write_to_log('T', 'INFO', 'info', 'start', '',
                                 f'info:start to initial synchronization for {self.res_name}')
        ...
        if drbd_primary['sts']:
            ...
            self.logger.write_to_log(
                'T', 'INFO', 'info', 'finish', '', f'{self.res_name} primary success')
        ...
        if result['sts']:
            ...
            if re_result:
                ...
                if status == 'UpToDate':
                    ...
                    self.logger.write_to_log(
                        'T', 'INFO', 'info', 'finish', '', f'{self.res_name} DRBD check successful')
...
class VplxCrm(object):
    def __init__(self, logger):
        ...
        self.logger.write_to_log(
            'T', 'INFO', 'info', 'start', '', f'start to config crm resource {self.lu_name}')
    ...
    def _crm_create(self):
        ...
        if result_crm_create['sts']:
            ...
            self.logger.write_to_log(
                'T', 'INFO', 'info', 'finish', '', 'create lu successful')
